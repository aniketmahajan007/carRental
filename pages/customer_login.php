    ...
    <script>
            ...
            if (Empty_check('signup'))
                ...
                if (ValidateEmail(email)) {
                    if (Pass_check(pass, repass)) {
                        $.ajax({
                            url: "../ajax_server/customer_register.php",
        ...
        $(document).on('click', '#loginBtn', function() {
            if (Empty_check('login'))
                ...
                $.ajax({
                    url: "../ajax_server/customer_login.php",
                ...
                <div class="forms">
                    ...
                    <form id="login">
                        ...
                        <div class="input-field">
                            ...
                            <input type="email" placeholder="Enter email" name="email" required="email" />
                    ...
                    <form id="signup">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter name" name="name" id="name" required="name" />
                            <label for="email">Email</label>
                            <input type="email" placeholder="Enter email" id="email" name="email" required="email" />
                            <label for="password">Password</label>
                            <input type="password" placeholder="Enter password" id="pass" name="password" required />
                            <label for="re-password">Confirm Password</label>
                            <input type="password" placeholder="Confirm Password" id="re-pass" name="re-password" required />
